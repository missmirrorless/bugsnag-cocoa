...
// files, arranged for use in BugsnagKSMach.

#ifndef HDR_BugsnagKSMachApple_h
#define HDR_BugsnagKSMachApple_h
...
typedef struct _pthread
{
    ...
    size_t         stacbugsnag_ksize;      /* Size of the stack (is a multiple of vm_page_size and >= PTHREAD_STACK_MIN) */
...
#endif // HDR_BugsnagKSMachApple_h
