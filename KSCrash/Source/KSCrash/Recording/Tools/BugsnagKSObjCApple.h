...
// files, arranged for use in BugsnagKSObjC.

#ifndef HDR_BugsnagKSObjCApple_h
#define HDR_BugsnagKSObjCApple_h
...
struct __CFBasicHashCallbacks {
    CFBasicHashCallbacks *(*copyCallbacbugsnag_ks)(CFConstBasicHashRef ht, CFAllocatorRef allocator, CFBasicHashCallbacks *cb);	// Return new value
    void (*freeCallbacbugsnag_ks)(CFConstBasicHashRef ht, CFAllocatorRef allocator, CFBasicHashCallbacks *cb);
...
#endif // HDR_BugsnagKSObjCApple_h
