...
Pod::Spec.new do |s|
  ...
  s.source_files = ["KSCrash/Source/KSCrash/Recording/**/*.{m,h,mm,c,cpp}",
                    "KSCrash/Source/KSCrash/Reporting/Filters/BugsnagKSCrashReportFilter.h",
                    "Source/Bugsnag/**/*.{m,h,mm,c,cpp}"]

  s.exclude_files = ["KSCrash/Source/KSCrash/Recording/Tools/BugsnagKSZombie.{h,m}"]

  s.requires_arc = true

  s.public_header_files = ["Source/Bugsnag/*.h", "KSCrash/Source/KSCrash/Reporting/Filters/BugsnagKSCrashReportFilter.h"]

  s.subspec 'no-arc' do |sp|
    sp.source_files = ["KSCrash/Source/KSCrash/Recording/Tools/BugsnagKSZombie.{h,m}"]
